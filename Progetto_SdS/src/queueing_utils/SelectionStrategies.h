...
// Aggiunto ThresholdSelectionStrategy
class QUEUEING_API ThresholdSelectionStrategy : public SelectionStrategy
{
    public:
        ThresholdSelectionStrategy(cSimpleModule *module, bool selectOnInGate);
        virtual int select() override;
};
